  ...
  return (
    <section className="bg-background py-16 md:py-20">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-2xl md:text-3xl font-serif text-[#AA1F33] mb-6">SI QUERES HACERNOS UN REGALO</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button className="bg-[#AA1F33] hover:bg-[#8B1A28] text-primary-foreground rounded-none px-12 py-6 text-base">
            CUENTA EN PESOS
          </Button>
          <Button className="bg-[#AA1F33] hover:bg-[#8B1A28] text-primary-foreground rounded-none px-12 py-6 text-base">
            CUENTA EN DÓLARES
